...
{
	public class DropzoneElement : UiElement, IDropzone
	{
		public DropzoneElement(IWebElement webElement)
			: base(webElement)
		{
		}

		/// <summary>
		/// Drops file from local machine location into drop zone using JavaScript
		/// </summary>
		/// <param name="filePath">
		/// Path to file.
		/// </param>
